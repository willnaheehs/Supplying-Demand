    ...
    <>
      ...
      <main className="cluster-app">
        <div className="lab-title">
          <div>
            <h1>Connect a client’s workload to the right cluster.</h1>
            <p>
              Compare offers, learn what drives the result, and establish what
              needs to be tested.
            </p>
          </div>
          <button
        ...
        <details
          ...
          ref={labRef}
          open={labOpen}
          onToggle={(e) => setLabOpen(e.currentTarget.open)}
        >
          <summary>
            Explore real cluster evidence & the visual sandbox
            <span>
              7 documented systems · hardware map · plain-English descriptions
            </span>
          </summary>
          {showGuide && (
            <div className="lc-guide">
              ...
              <span>
                Click a source card to inspect a real disclosure. Click “Explore
                a variant” to create a scenario. Drag components onto their
                matching block, or click a palette item. Change the workload and
                follow the colored paths. Open “Data” below for exact benchmark
                conditions.
              </span>
              <button
