...
export default function ClusterLab() {
  ...
  const latest = useRef({ scenario, recordId, observed });
  latest.current = { scenario, recordId, observed };
  useEffect(() => {
    type Tool = {
      name: string;
      description: string;
      ...
      <main className="cluster-app">
        <div className="lab-title">
          <div>
            ...
            <p>
              Choose a documented system, or drag components into your own
              scenario.
            </p>
          </div>
          <button
          ...
          >
            <span className="data-dot" />7 systems · 4 benchmark runs
            <ChevronDown size={15} />
          </button>
        </div>
        {showGuide && (
                  ...
                  <i
                    style={{
                      width: observed
                        ...
                        : Math.min(
                            100,
                            (a.nsRequiredGbps / Math.max(1, scenario.nsGbps)) *
                              100,
                          ) + '%',
                      background:
                ...
                <>
                    ...
                    <>
                      ...
                      {scenario.workload === 'inference' ? (
                        <>
                          ...
                          {numeric('context', 'Resident tokens per sequence', {
                            min: 1,
                            max: 1e7,
                            integer: true,
                          })}
                  ...
                  {part === 'compute' && (
                    <>
                      ...
                      <div className="lab-note">
                        HBM does not automatically pool across GPUs. The runtime
                        must support the partitioning, and each GPU’s state must
                        fit.
                      </div>
                      {sourceLink(
                  ...
                  {part === 'fabric' && (
                    <>
                      ...
                      <div className="lab-note">
                        Nominal capacity ratio: {fmt(a.oversub)}:1. Link counts,
                        rails, oversubscription and contention must be validated
                        as a complete topology.
                      </div>
                      <p>
                  ...
                  {part === 'frontend' && (
                    <>
                      {numeric('nsGbps', 'Aggregate frontend capacity · Gb/s', {
                        max: 102400,
                      })}
                      ...
                      <p>
                        ...
                        links are budgeted by the larger direction, not ingress
                        plus egress.
                      </p>
                    </>
                  )}
                  {part === 'storage' && (
                    <>
                      ...
                      {numeric('storageNic', 'NIC bandwidth / server · Gb/s', {
                        max: 6400,
                      })}
                      {numeric('rawTBPerStorage', 'Raw drives / server · TB')}
                      {numeric('protection', 'Raw-to-usable capacity factor', {
                        min: 1,
                        max: 10,
                  ...
                  {part === 'operations' && (
                    <>
                      ...
                      <div className="lab-note">
                        ...
                        power, cooling and scheduling all require an OEM design
                        and workload acceptance tests.
                      </div>
                      <div className="lc-field">
          ...
          {showData && (
            <div className="data-content">
              ...
              <p className="comparison-warning">
                These records use different MLPerf versions, software and weight
                precision. The bars show submitted results, not a controlled
                GPU-only comparison or a prediction for this scenario. Neither
                single-node result establishes RoCE performance across nodes.
              </p>
              ...
              <div className="data-calculations">
                <div>
                    ...
                    <i
                      style={{
                        width:
                          Math.min(
                            100,
                            (a.egress / Math.max(a.ingress, a.egress, 1)) * 100,
                          ) + '%',
                      }}
                    />
                  ...
                  <p>
                    Egress = client response payloads + {fmt(a.checkpointRate)}{' '}
                    GB/s checkpoint writes.
                  </p>
                  <code>
                  ...
                  <p>
                    Full-duplex aggregate planning assumption. Validate per-node
                    NICs, each network cut, protocol overhead, bursts and
                    failure headroom.
                  </p>
                </div>
                <div>
              ...
              <details>
                ...
                <p>
                  ...
                  concurrent sequences × KV bytes. Full training uses an assumed
                  16 bytes per parameter across weights, gradients, master
                  weights and optimizer state. Add the activation/scratch
